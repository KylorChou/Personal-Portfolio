...
export const AnimatedBorderButton = ({ children }) => {
    return (
        <button
            ...
            font-medium rounded-full overflow-visible animate-border"
        >
            { /* Animated SVG Border */}
            <svg 
            ...
            >
                <path 
                    d="M 20, 1 A 29, 29 0 0 0 1, 30 L 1, 30 A 29, 29 0 0 0 30, 59 L 170, 59 A 29, 29 0 0 0 199, 30 L 199, 30 A 29, 29 0 0 0 170, 1 Z"
                    fill="none"
